...
export class GeminiAgent{
    ...
    /**
     * Handles incoming audio data from the model based on current output mode
     * and camera/screen share status
     */
    handleModelAudio(data) {
        try {
            ...
            // Always send to transcriber regardless of output mode
    ...
    setupEventListeners() {
        ...
        Z    @// TODO: Handle multiple function calls
            ...
            this.screenInterval = setInterval(async () => {
                ...
                if (this.connected && this.client && this.client.ws && 
                    ...
                    try {
                        ...
                        console.warn('Error capturing or sending screen image:', error);
                    }
                } else {
                    // WebSocket is not open, stop the screen sharing
                    console.warn('WebSocket is not connected. Stopping screen sharing.');
