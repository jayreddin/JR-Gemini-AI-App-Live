...
<div class="settings-dialog">
  ...
  <md-tabs>
    <md-primary-tab>API</md-primary-tab>
    <md-primary-tab>Advanced</md-primary-tab>
    <md-primary-tab>UI</md-primary-tab>
    <md-primary-tab>Audio</md-primary-tab>
    <md-primary-tab>Cam/SCRN</md-primary-tab>
    <md-primary-tab>Misc</md-primary-tab>
  </md-tabs>

  <div class="tab-content" id="api-panel">
    <div class="field-row">
      <md-filled-text-field type="password" id="apiKey" label="Gemini API Key"></md-filled-text-field>
      <md-icon-button id="checkGeminiKey" title="Check Gemini API Key"><md-icon>check</md-icon></md-icon-button>
    </div>
    <div class="field-row">
      <md-filled-text-field type="password" id="deepgramApiKey" label="Deepgram API Key (Optional)"></md-filled-text-field>
      <md-icon-button id="checkDeepgramKey" title="Check Deepgram API Key"><md-icon>check</md-icon></md-icon-button>
    </div>
  </div>
